...
body, h1, h2, h3, h4, h5, h6, p, span, div, small, b {
    color: black ;
}
...
<div class="container">
    ...
    <p><b><i class="fa fa-map-marker"></i> Location:</b> <?php echo htmlspecialchars($location); ?></p>

    <p><b><i class="fa fa-building"></i> Department:</b> <?php echo htmlspecialchars($department); ?></p>
					...
					<div class="col-md-12">
						...
						<div class="text-center">
							...
							<?php if(in_array($_SESSION['login_id'], $cids)): ?>
								<span style="background-color: yellow"  class="badge badge-primary">Commited to Participate</span>
							<?php else: ?>
