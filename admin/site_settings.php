...
<div class="container-fluid">
    ...
    <input type="text" class="form-control" id="location" name="location" value="<?php echo isset($meta['location']) ? $meta['location'] : '' ?>" required>
</div>


<div class="form-group">
    <label for="facebook" class="control-label">Facebook Page</label>
    <input type="text" class="form-control" id="facebook" name="facebook" value="<?php echo isset($meta['facebook']) ? $meta['facebook'] : '' ?>">
</div>
