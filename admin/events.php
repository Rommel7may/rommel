...
<div class="container-fluid">
    ...
    <td><p><b><?php echo date("M d, Y h:i A",strtotime($row['schedule'])) ?></b></p></td>
    <td><p><b><?php echo ucwords($row['title']) ?></b></p></td>
    <td><p class="truncate"><?php echo strip_tags($desc) ?></p></td>
    <td><p><?php echo ucwords($row['location']) ?></p></td>
	<td><p><?php echo ucwords($row['department']) ?></p></td>
    <td><p class="text-right"><?php echo $commits ?></p></td>
